...
class AccountReport(models.Model):
        ...
        companies = (
            ...
            .browse(
                [
                    ...
                    if journal["id"] != "divider" and journal["model"] != "account.journal.group"
                ]
            )
            .mapped("company_id")
        )
    ...
    def _report_create_settlement_entry(self, journal, options, account):
        ...
        for report_expression in report_expressions:
            ...
            expression_domain = fields.Domain.AND([ast.literal_eval(report_expression.formula) + options_domain])
